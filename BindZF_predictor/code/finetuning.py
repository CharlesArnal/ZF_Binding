...
def evaluate_by_len(model_generator, input_encoder, output_spec, seqs, raw_Y, i, pred_add, start_seq_len = 512, start_batch_size = 32, increase_factor = 2):
    ...
    print(y_pred)
    np.save(pred_add + '/predictions/' + 'pred' + str(i), y_pred)
